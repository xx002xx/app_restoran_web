...
<body class="hold-transition login-page" style="background-color: black;">
   <div class="login-box">
      <div class="login-logo">
         <a style="color:aliceblue" href="<?php echo base_url(); ?>auth"><b>My</b> Resto APP</a>
      </div>
      <!-- /.login-logo -->
      <div class="login-box-body">
         ...
         <div class="row">
            <div class="col-xs-4">
               <button type="submit" class="btn btn-danger btn-block btn-flat"><i class="fa fa-sign-in"
