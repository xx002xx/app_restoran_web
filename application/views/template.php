   ...
   <div class="wrapper">
      ...
      <header class="main-header">
         ...
         <a href="<?php echo base_url() ?>welcome" class="logo">
            ...
            <span class="logo-mini"><b>My</b>R</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>My</b>Resto</span>
         </a>
               ...
               <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user user-menu">
                     <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img
                           src="<?php echo base_url() ?>assets/foto_profil/<?php echo $this->session->userdata('images'); ?>"
      ...
      <footer class="main-footer">
         ...
         <strong>Copyright &copy; <?php echo date("Y") ?> My Resto</strong>
         All
         rights
         reserved.
      </footer>
