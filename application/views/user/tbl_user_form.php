      ...
      <div class="box box-warning box-solid">
         ...
         <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
            ...
            <table class='table table-bordered>' <tr>
               ...
               <tr>
                  <td width='200'>Restoran <?php echo form_error('id_restoran') ?></td>
                  <td>
                     <?php echo cmb_dinamis('id_restoran', 'restoran', 'nama_restoran', 'id_restoran', $id_restoran,'DESC') ?>
                     <!--<input type="text" class="form-control" name="id_user_level" id="id_user_level" placeholder="Id User Level" value="<?php echo $id_restoran; ?>" />-->
                  </td>
               </tr>
               <tr>
